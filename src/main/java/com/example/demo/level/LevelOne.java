...
public class LevelOne extends LevelParent {
	...
	private void updateWarningImages() {
		int numberOfWarningAreaEnemies = getNumberOfEnemiesInWarningAres();
		List<Double> enemyYPositions = getWarningAreaEnemiesYPositions();

		if (numberOfWarningAreaEnemies > 0) {
			levelView.setWarningImagesVisible(numberOfWarningAreaEnemies);
			levelView.setWarningImagesPositions(enemyYPositions);
		}
		else {
			levelView.setWarningImagesInvisible();
		}
	}
}
